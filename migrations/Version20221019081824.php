 ...
 */
final class Version20221019081824 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material_algeco_order_sign ADD aisle_number INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE material_algeco_order_sign DROP aisle_number, CHANGE dir dir VARCHAR(1) NOT NULL COLLATE `utf8mb4_unicode_ci`');
